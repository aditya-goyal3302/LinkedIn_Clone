...
//comments_routes
//sub-comments_routes
router.post('/sub-comment/:comment_id',auth_middleware.verify_auth, comments_controller.create_sub_comment);
router.get('/sub-comment/:comment_id',auth_middleware.verify_auth, comments_controller.view_sub_comment);
//sub-comments_routes
