...
import { Input, FormControl, Typography, InputAdornment, Fab, Divider, TextField } from '@mui/material';
        ...
        <Box className={styles.root}>
            <Box className={styles.main_wrap}>
                ...
                <Typography className={styles.title}>Make the most of your professional life</Typography>
                    ...
                    <Box>
                        <Typography className={styles.sign_up_text}>New to LinkedIn? <Link className={styles.sign_up_link}>Join now</Link></Typography>
                    </Box>
                </Box>
            </Box>
