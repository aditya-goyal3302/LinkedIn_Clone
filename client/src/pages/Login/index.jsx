...
import { TextField, FormControl, Typography, InputAdornment, Fab, Divider, ImageList } from '@mui/material';
            ...
            <Box className={styles.box_wraper}>
                <Box className={styles.box}>
                    ...
                    <Box>
                        ...
                        <Typography className={styles.txt_oauth_text} >By clicking Continue, you agree to LinkedIn’s <Link className={styles.policy_links}>User Agreement</Link>,<Link className={styles.policy_links}> Privacy Policy</Link>, and <Link className={styles.policy_links}>Cookie Policy</Link>.</Typography>
