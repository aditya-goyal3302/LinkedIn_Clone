    ...
    <Box className={styles.mainBody}>
      ...
      <Box className={styles.leftPanel}>
        <Box className={styles.profile}>
          ...
          <Box className={styles.profileCounts}>
            <Box className={styles.profileCount}>
              <Typography className={styles.profileCountText}>
                Profile Viewers
              </Typography>
          ...
          <Box className={styles.offerSection}>
            <Typography className={styles.offerSectionText}>
              Strengthen your profile with an AI writing assistant
            </Typography>
            <Typography className={styles.offerSectionBtn}>
              Reactivate Premium: 50% Off
            </Typography>
          </Box>
          <Box className={styles.myItems}>
            <Typography className={styles.myItemsBtn}>
              <Ribbon />
              My Items
            </Typography>
          </Box>
        ...
        <Box className={styles.discoverTab}>
          ...
          <Typography className={styles.discoverTabBtn}>
            Events <Plus />
          </Typography>
          <Typography className={styles.discoverTabBtn}>
            Followed Hashtags
          ...
          <Box className={styles.createPost}>
            <Box className={styles.createPostWrapHead}>
              ...
              <Box
                ...
                className={styles.createPostWrapHeadInput}
              >
            ...
            <Box className={styles.createPostWrapBody}>
              <ButtonGroup
                className={styles.createPostWrapBodyBtns}
                variant="text"
              >
